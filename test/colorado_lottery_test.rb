...
class ColoradoLotteryTest < MiniTest::Test
  ...
  def test_it_exists_with_attributes
    ...
    assert_instance_of Hash, @lottery.current_contestants
    assert_empty @lottery.current_contestants
  end

  def test_it_knows_who_is_18_and_interested
  ...
  def test_it_knows_who_can_register
  ...
  def test_it_knows_the_eligible_contestants
    @lottery.register_contestant(@alexander, @pick_4)
    @lottery.register_contestant(@alexander, @mega_millions)
  ...
  def test_it_has_current_contestants_who_are_charged
    @lottery.register_contestant(@alexander, @pick_4)
    @lottery.register_contestant(@alexander, @mega_millions)
    @lottery.register_contestant(@frederick, @mega_millions)
  ...
  def test_it_can_announce_winners
    ...
    @lottery.expects(:announce_winner).returns("Grace Hopper won the Pick 4 on 04/07")
    @lottery.expects(:announce_winner).returns("Winston Churchill won the Cash 5 on 04/07")
    @lottery.expects(:announce_winner).returns("Frederick Douglas won the Mega Millions on 04/07")

    assert_equal "Frederick Douglas won the Mega Millions on 04/07", @lottery.announce_winner("Mega Millions")
    assert_equal "Winston Churchill won the Cash 5 on 04/07", @lottery.announce_winner("Cash 5")
    assert_equal "Grace Hopper won the Pick 4 on 04/07", @lottery.announce_winner("Pick 4")
  end
